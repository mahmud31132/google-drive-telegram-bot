class config:
    ...
    APP_ID = "7105813"
    API_HASH = "f041ce494cccb67f770141044213b91e"
    DATABASE_URL = ""
    SUDO_USERS = "" # Sepearted by space.
    SUPPORT_CHAT_LINK = ""
    DOWNLOAD_DIRECTORY = "./downloads/"
    G_DRIVE_CLIENT_ID = "737756335071-f6seqpk8vd28rreqk7pn0ddfug3rcvtv.apps.googleusercontent.com"
    G_DRIVE_CLIENT_SECRET = "TklF2Z-p67Flt664REDjNj2l"
...
class Messages:
    ...
    PROVIDE_YTDL_LINK = "❗**দয়া করে সঠিক লিংক প্রদান করুন! মনে রাখবেন শুধুমাত্র ইউটিউব লিংক ব্যাথিত অন্যকোন লিংক প্রদান করবেন না ধন্যবাদ :).**"
